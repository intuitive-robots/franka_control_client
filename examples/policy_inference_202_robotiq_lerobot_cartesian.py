...
if __name__ == "__main__":
    ...
    checkpoint_path = (
        "/home/jjiang/jing/model/2026-04-09/pickupbanana_ac10_data40/checkpoints/010000/pretrained_model" 
    )
    task = "pick_up_banana"  # Task name for inference, should match the one used during training
